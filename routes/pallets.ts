...
// Create pallet
export const createPallet: RequestHandler<
  { sessionId: string },
  any,
  { locationNote?: string }
> = async (req, res) => {
...
export const updatePallet: RequestHandler<
  { palletId: string },
  any,
  { locationNote?: string }
> = async (req, res) => {
...
// Delete pallet
export const deletePallet: RequestHandler<{ palletId: string }> = async (
  req,
  res
) => {
  try {
...
export const addStockLine: RequestHandler<
  { palletId: string },
  any,
  {
    itemId: string;
...
// Update stock line
export const updateStockLine: RequestHandler<
  { stockLineId: string },
  any,
  {
    units?: number;
...
> = async (req, res) => {
  try {
    ...
    if (!stockLine) return res.status(404).json({ error: "Stock line not found" });
...
// Delete stock line
export const deleteStockLine: RequestHandler<{ stockLineId: string }> = async (
  req,
  res
) => {
  try {
